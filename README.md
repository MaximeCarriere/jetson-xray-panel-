...
| [XP15](experiments/xp15_timing_sidechannel/) | Timing side-channel | inference time leaks the **model/resolution** (2×) but **not the image content** — a chest X-ray and a CIFAR car time within 0.13% — constant-time in content by construction |
